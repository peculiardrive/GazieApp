    ...
    <div className="flex flex-col min-h-screen bg-gazie-paper text-gazie-navy">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-5 py-10 space-y-8">
        ...
        <div className="font-sans text-sm text-gazie-navy/85 space-y-9 leading-relaxed">
          ...
          {/* Section 4: Comprehensive Refund Policy */}
          <section className="space-y-4 bg-white border-2 border-gazie-navy rounded-2xl p-6 shadow-sm">
            <div className="border-b border-dashed border-gazie-navy/15 pb-3">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-gazie-navy text-white text-[10px] font-bold uppercase tracking-wider mb-1">
                <ShieldCheck className="w-3.5 h-3.5" /> Consumer Guarantee & Fee Protection
              </div>
              <h2 className="font-display font-black text-xl tracking-tight text-gazie-navy uppercase">
                4. Comprehensive Refund & Reversal Policy
              </h2>
            </div>

            <p className="text-xs font-semibold text-gazie-navy/80">
              In full accordance with the <strong>Federal Competition and Consumer Protection Act (FCCPA) 2018</strong>, Gazie Commute maintains a transparent, time-bound refund procedure for all platform unlock fees:
            </p>

            {/* 4.1 Eligibility */}
            <div className="space-y-2 text-xs">
              <h3 className="font-bold text-gazie-navy text-sm uppercase tracking-wide">
                4.1 Refund Eligibility Criteria
              </h3>
              <p className="text-gazie-navy/80">A commuter is entitled to a 100% refund or free booking pass credit under any of the following circumstances:</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                <div className="p-3 bg-green-50/60 border border-gazie-green/20 rounded-xl">
                  <span className="font-bold text-gazie-navy block">✓ Driver Cancellation</span>
                  <p className="text-gazie-navy/70">The driver cancels the scheduled commute after you have paid the match unlock fee.</p>
                </div>
                <div className="p-3 bg-green-50/60 border border-gazie-green/20 rounded-xl">
                  <span className="font-bold text-gazie-navy block">✓ Driver No-Show</span>
                  <p className="text-gazie-navy/70">The driver fails to arrive at the agreed pickup landmark within 15 minutes of scheduled departure.</p>
                </div>
                <div className="p-3 bg-green-50/60 border border-gazie-green/20 rounded-xl">
                  <span className="font-bold text-gazie-navy block">✓ Schedule Discrepancy</span>
                  <p className="text-gazie-navy/70">The driver alters the departure time or route after confirmation and you cannot accommodate the change.</p>
                </div>
                <div className="p-3 bg-green-50/60 border border-gazie-green/20 rounded-xl">
                  <span className="font-bold text-gazie-navy block">✓ Billing & System Errors</span>
                  <p className="text-gazie-navy/70">Duplicate debits, network dropouts during payment, or technical platform allocation failures.</p>
                </div>
              </div>
              <p className="text-[11px] text-gazie-navy/60 italic pt-1">
                *Note: Refunds are not issued if the passenger cancels without cause within two (2) hours of departure or fails to show up at the designated pickup point.
              </p>
            </div>

            {/* 4.2 Request Procedure & Response Time */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs pt-2">
              <div className="p-3.5 bg-gazie-paper/50 border border-gazie-navy/20 rounded-xl space-y-1">
                <span className="font-bold text-gazie-navy block text-[11px] uppercase tracking-wider">1. Request Procedure</span>
                <p className="text-gazie-navy/70 leading-relaxed">
                  Email <a href="mailto:gaziecommute@gmail.com" className="underline font-bold text-gazie-green">gaziecommute@gmail.com</a> or message WhatsApp at <a href="https://wa.me/2348164737221" target="_blank" rel="noopener noreferrer" className="underline font-bold text-gazie-green">+234 816 473 7221</a> with your <strong>Booking ID / Ticket Code</strong> and <strong>Paystack Reference</strong>.
                </p>
              </div>

              <div className="p-3.5 bg-gazie-paper/50 border border-gazie-navy/20 rounded-xl space-y-1">
                <span className="font-bold text-gazie-navy block text-[11px] uppercase tracking-wider">2. Response Time</span>
                <p className="text-gazie-navy/70 leading-relaxed">
                  Requests are formally acknowledged within <strong>2 to 4 business hours</strong>, and eligibility verification is completed within <strong>24 hours</strong> of submission.
                </p>
              </div>

              <div className="p-3.5 bg-gazie-paper/50 border border-gazie-navy/20 rounded-xl space-y-1">
                <span className="font-bold text-gazie-navy block text-[11px] uppercase tracking-wider">3. Refund Methods & Settlement</span>
                <p className="text-gazie-navy/70 leading-relaxed">
                  Reversals are credited back to your <strong>original bank account / debit card</strong> via Paystack within <strong>1 to 3 banking business days</strong>, or credited as an <strong>instant platform pass</strong> upon request.
                </p>
              </div>
            </div>
          </section>
          ...
          {/* Section 7: Legally Compliant Liability Framework */}
          <section className="space-y-4 bg-white border-2 border-gazie-navy rounded-2xl p-6 shadow-sm">
            <div className="border-b border-dashed border-gazie-navy/15 pb-3">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-gazie-navy text-white text-[10px] font-bold uppercase tracking-wider mb-1">
              ...
              <h2 className="font-display font-black text-xl tracking-tight text-gazie-navy uppercase">
                7. Apportionment of Responsibility & Limitation of Liability
              </h2>
            </div>
            ...
            {/* 7.1 What Gazie is Responsible For */}
            <div className="p-4 bg-green-50/70 border border-gazie-green/30 rounded-xl space-y-2 text-xs">
              <h3 className="font-bold text-gazie-green text-sm flex items-center gap-1.5 uppercase tracking-wide">
                ...
                7.1 Gazie Commute Responsibilities & Duty of Care
              </h3>
            ...
            {/* 7.2 Driver & Vehicle Responsibilities */}
            <div className="p-4 bg-gazie-paper/60 border border-gazie-navy/20 rounded-xl space-y-2 text-xs">
              <h3 className="font-bold text-gazie-navy text-sm flex items-center gap-1.5 uppercase tracking-wide">
                ...
                7.2 Independent Driver & Car Owner Responsibilities
              </h3>
              <p className="text-gazie-navy/80 leading-relaxed">
            ...
            {/* 7.3 Third-Party & Road Risk Disclaimers */}
            <div className="space-y-2 text-xs text-gazie-navy/75 leading-relaxed">
              <h3 className="font-bold text-gazie-navy uppercase tracking-wider text-[11px]">
                7.3 General Road Conditions & Third-Party Events
              </h3>
              <p>
            ...
            {/* 7.4 Statutory Consumer Protection Non-Exclusion */}
          ...
          <section className="space-y-3">
            <h2 className="font-display font-extrabold text-lg uppercase tracking-tight text-gazie-navy flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-gazie-navy text-white inline-flex items-center justify-center text-xs">8</span>
          ...
          <section className="space-y-3 border-t-2 border-dashed border-gazie-navy/15 pt-6">
            <h2 className="font-display font-extrabold text-sm uppercase tracking-tight text-gazie-navy">
              9. Corporate Identity, Contact & Support
            </h2>
